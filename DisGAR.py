...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name_or_path", type=str, default="/root/autodl-tmp/gemma", help="base model")
    parser.add_argument("--train_file", type=str, default="./dataset/train/OOD/academic.csv", help="training set path")
    parser.add_argument("--eval_file", type=str, default="./dataset/train/OOD/email.csv", help="test set path")
    parser.add_argument("--output_dir", type=str, default="test_111", help="model save path")
    
    # 纯验证/恢复训练时，提供这个参数
    parser.add_argument("--checkpoint_dir", type=str, default="./model/new/ours/epoch_3", help="model loading path")
